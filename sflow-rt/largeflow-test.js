...
//instruct incoming match entry to go to flow table 1 from table 0
//three tables. First for filter flow.Second for significant flow. THird for micro flow
    ...
    function(metrics) {
      if(metrics && metrics.length == 1) {
	   ...
	   /* flow start from client once......*/
		...
		insertFlow("00:00:00:00:00:00:00:01", "flow_mod_1","1",  topKey);
		insertFlow("00:00:00:00:00:00:00:02", "flow_mod_2","2",  topKey);
		insertFlow("00:00:00:00:00:00:00:03", "flow_mod_3","1",  topKey);
		insertFlow("00:00:00:00:00:00:00:04", "flow_mod_4","3",  topKey);

		insertFlow2("00:00:00:00:00:00:00:01", "flow_mod_5","2",  topKey);
		insertFlow2("00:00:00:00:00:00:00:02", "flow_mod_6","1",  topKey);
		insertFlow2("00:00:00:00:00:00:00:03", "flow_mod_7","3",  topKey);
		insertFlow2("00:00:00:00:00:00:00:04", "flow_mod_8","1",  topKey);
 		insertsigflowcount++;
            } 
	    /*else{
	       console.log(" gototable1 ");
	       gototable1("00:00:00:00:00:00:00:01", topKey);
	       gototable1("00:00:00:00:00:00:00:03", topKey);
	       gototable1("00:00:00:00:00:00:00:04", topKey);
	     }*/
	   ...
	   /*try insert only once......*/
		...
		//insertMicroFlow2("00:00:00:00:00:00:00:04", "flow_mod_12","2",  topKey);
		 insertmicroflowcount++;
	        ...
	        console.log(" gototable2 ");
	       gototable2("00:00:00:00:00:00:00:01", topKey);
	       gototable2("00:00:00:00:00:00:00:02", topKey);
	       gototable2("00:00:00:00:00:00:00:04", topKey);
	     }
	     */
